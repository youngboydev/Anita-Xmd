...
function startCleanup() {
  ...
  console.log(chalk.yellow('🧹 Starting temp file cleanup system...'));
  cleanupOldFiles();
  ...
  console.log(chalk.green(`✅ Cleanup system started (runs every ${CLEANUP_INTERVAL_MS / 1000 / 60} minutes)`));
}
